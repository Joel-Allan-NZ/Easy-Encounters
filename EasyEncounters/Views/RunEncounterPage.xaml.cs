...
/// </summary>
public sealed partial class RunEncounterPage : Page
{
    public RunEncounterViewModel ViewModel
    {
        get;
    }
    public RunEncounterPage()
    {
        ViewModel = App.GetService<RunEncounterViewModel>();
